...
const Hero = () => {
    ...
    return (
        <div className="w-full">
            <video className="w-full h-[90vh] lg:h-[80vh] relative object-cover" autoPlay loop muted>
                <source src={workspaceVideo} type="video/mp4" />
            </video>
            <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:54px_54px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
            <div className="absolute inset-0 bg-gradient-to-tr h-[90vh] lg:h-[80vh] from-black/60 via-black/40 to-slate-200/25">
